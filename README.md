...
Clothes Shop (Simple Mode)

## Description

E-Commerce website that sell clothes for buyer with simple style code
...
Clone the repository
    ...
    git clone https://github.com/Sleepy4k/laravel-clothes-shop-simple.git

Switch to the repo folder

    cd laravel-clothes-shop-simple
